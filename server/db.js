...
function openDb() {
  ...
  if (firstBootInfo) {
    ...
    console.warn("[hrms] ========== FIRST BOOT (automatic) ==========");
    console.warn("[hrms] Database file:", absDb);
    console.warn("[hrms] Super admin email:", firstBootInfo.email);
    console.warn("[hrms] Super admin password:", firstBootInfo.adminPassword);
    if (firstBootInfo.autoGenerated) {
      console.warn(
        "[hrms] Password was auto-generated and stored in the database for stable logins across restarts."
      );
    }
    console.warn("[hrms] =============================================");
  }
